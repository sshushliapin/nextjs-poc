...
Add-HostsEntry "cm.poc.localhost"
Add-HostsEntry "cd.poc.localhost"
Add-HostsEntry "id.poc.localhost"
Add-HostsEntry "www.poc.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.poc.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.poc.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.poc.localhost"
